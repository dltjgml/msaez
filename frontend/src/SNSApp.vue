...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'Delievery', 
                description: 'Delievery을 관리하는 화면입니다.', 
                key: 'delieveries', 
                route: '/deliveries/delieveries',
                ImageUrl: '',
            },
            { 
                title: 'Inventory', 
            ...
            { 
                title: 'SearchProduct', 
                description: 'Search Product을 관리하는 화면입니다.', 
                key: 'searchProducts', 
                route: '/orders/searchProducts',
                ImageUrl: '',
            },
